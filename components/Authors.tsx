  ...
  const authorsInfo: author[] = [
    {
      ...
      url: "https://bsraya.vercel.app/",
    },
    {
      name: "Annabella Putri Dirgo",
      image: "https://bellapd.vercel.app/images/avatar.png",
      url: "/",
    },
    {
      name: "Marcelino Gilbert Tagore",
      image: "https://marcelinogilbertt.vercel.app/images/avatar.png/",
  ...
  return (
    <Box mb={5}>
      ...
      <Wrap>
        ...
        props.authors[0] === authorsInfo[0].name ? (
          <WrapItem>
            <NextLink href={authorsInfo[0].url} passHref>
              <Avatar
          ...
          props.authors.map((name: string) => {
            if (name === authorsInfo[0].name) {
              return (
                <Tooltip key={name} label={authorsInfo[0].name}>
                  <WrapItem
                    _hover={{
                      cursor: "pointer",
                    }}
            ...
            if (name === authorsInfo[1].name) {
              return (
                <Tooltip key={name} label={authorsInfo[1].name}>
                  <Link href={authorsInfo[1].url} target="_blank" isExternal>
                    <WrapItem>
                      <Avatar
