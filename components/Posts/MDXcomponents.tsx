...
const MDXComponent = {
  ...
  p: (props: any) => (
    <Text as="p" mt={5} mb={10} wordBreak={"break-word"} {...props} />
  ),

  li: (props: any) => <ListItem ml={6} {...props} />,
  ul: (props: any) => (
    <List as="ul" styleType="circle" my="1.5rem" {...props} />
  ),
  ol: (props: any) => (
    <List as="ol" styleType="decimal" my="1.5rem" {...props} />
  ),

  h2: (props: any) => (
    <DocsHeading as="h2" size="xl" fontWeight="bold" {...props} />
  ),
  h3: (props: any) => (
    <DocsHeading as="h3" size="lg" fontWeight="bold" {...props} />
  ),
  h4: (props: any) => (
    <DocsHeading as="h4" size="md" fontWeight="bold" {...props} />
  ),
  h5: (props: any) => (
